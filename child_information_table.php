...
<?php } else {
	...
	if(empty($count_child_information)){
		...
		if ($Height_Status == "Severely Stunted") {
			
			$table_status_h = "child_information_table_severely_stunted.php";
			
		}else if ($Height_Status == "Stunted") {
			
			$table_status_h = "child_information_table_stunted.php";
			
		}else if ($Height_Status == "Normal"){
			$table_status_h = "child_information_table_normal_h.php";
			
		}else if ($Height_Status == "Tall"){
			$table_status_h = "child_information_table_tall.php";
		}else {
		...
		if ($Weight_Status == "Severely Underweight") {
			
			$table_status_w = "child_information_table_severely_underweight.php";
			
		}else if ($Weight_Status == "Underweight") {
			
			$table_status_w = "child_information_table_underweight.php";
			
		}else if ($Weight_Status == "Normal"){
			$table_status_w = "child_information_table_normal_w.php";
			
		}else if ($Weight_Status == "Overweight"){
			$table_status_w = "child_information_table_overweight.php";
		}else {
		...
		if ($child_Sex == "Male"){
			...
			$gender = "male_table.php";
			
		}else {
			$gender = "female_table.php";
		}
		...
		echo '<td>'.$child_Name.'</td>';
		echo '<td>'.$child_Age.' '.$mo.'</td>';
		echo '<td>'.'<a href="'.$gender.'">'.$child_Sex.'</a>'.'</td>';
		echo '<td>'.$child_Address.'</td>';
		echo '<td>'.$child_Weight.' '.$kg.'</td>';
		echo '<td>'.$child_Height. ' '.$cm.'</td>';
		echo '<td>'.$child_Guardian.'</td>';
		echo '<td>'.'<a href="'.$table_status_h.'">'.$Height_Status.'</a>'.'<br>'.'<a href="'.$table_status_w.'">'.$Weight_Status.'</a>'.'</td>';
