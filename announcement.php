...
<li class="active"><span  class="fa fa-exclamation"></span> <a href="announcement.php">Announcement</a></li>
...
$show_account = $conn->query("SELECT *FROM announcement");
...
<div>
<label>Message:</label> <p><?php echo $message ?></p>
</div>
