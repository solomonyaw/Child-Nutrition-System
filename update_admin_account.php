...
.admin_border {
	...
	border-top: 2px solid #4FA88A;
	border-bottom: 2px solid #4FA88A;
}
...
<?php
		...
		$create_user_account=1;
							...
							*/
							...
							$show_admin_id = $conn->query("SELECT *FROM admin_account WHERE Authorization = 'admin'");
							
							while($row=$show_admin_id->fetch()){
								
							$admin_id = $row['IDNumber'];
							
							
							
							
							//UPDATE THE admin_account 
							$update_admin = $conn->query("UPDATE admin_account SET ProfilePhoto ='$profile_photo' WHERE IDNumber = $admin_id");
							$update_admin = $conn->query("UPDATE admin_account SET FirstName ='$first_name' WHERE IDNumber = $admin_id");
							$update_admin = $conn->query("UPDATE admin_account SET MiddleName ='$middle_name' WHERE IDNumber = $admin_id");
							$update_admin = $conn->query("UPDATE admin_account SET LastName ='$last_name' WHERE IDNumber = $admin_id");
							$update_admin = $conn->query("UPDATE admin_account SET UserName ='$username' WHERE IDNumber = $admin_id");
							$update_admin = $conn->query("UPDATE admin_account SET Password ='$password' WHERE IDNumber = $admin_id");
							$update_admin = $conn->query("UPDATE admin_account SET ConfirmPassword ='$confirm_password' WHERE IDNumber = $admin_id");
							$update_admin = $conn->query("UPDATE admin_account SET BirthMonth ='$date_of_birth' WHERE IDNumber = $admin_id");
							$update_admin = $conn->query("UPDATE admin_account SET Age ='$age' WHERE IDNumber = $admin_id");
							$update_admin = $conn->query("UPDATE admin_account SET BirthPlace ='$birth_place' WHERE IDNumber = $admin_id");
							$update_admin = $conn->query("UPDATE admin_account SET Address ='$address' WHERE IDNumber = $admin_id");
...
<ul class="sidenavmenus">
 ...
 <i  class="fa fa-pencil-square-o fa-lg"></i><span class="active">Update Admin Account</span>
 </a>
 </li>
...
<!--UPDATE ADMIN ACCOUNT HEADER----------------------------------------------------------------------------------------------------------------------------------------------------------------------->
<div class="create_account_container">
<div class="create_header">Update Admin Account</div>
</div>


<!--UPDATE ADMIN ACCOUNT  FORM----------------------------------------------------------------------------------------------------------------------------------------------------------------------->
<div class="responsive">
<div class="create_account admin_border">
...
<input type="date" name="date_of_birth" placeholder="Enter Date" required/>
</div>


<div>
<label> Birth Place: </label>
<input type="text" name="birth_place" placeholder="Enter Birth Place " required/>
</div>
