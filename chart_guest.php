...
<li><span  class="fa fa-home "></span> <a href="home_guest.php">Home </a></li>
...
<li class="active"><span  class="fa fa-pie-chart "></span> <a href="chart_guest.php">Chart </a></li>
...
<a class="active" href="chart_guest.php">Overall</a>
<a href="chart_guest_boys.php">Boys</a>
<a href="chart_guest_girls.php">Girls</a>
</div>
</div>
...
//GET STATUS HEIGHT
    ...
    $show_severely_stunted = $conn->query("SELECT *FROM child_information WHERE Height_Status LIKE '%".$severely_stunted."%'");
	...
	//STUNTED
	$stunted = "Stunted";
    $show_stunted = $conn->query("SELECT *FROM child_information WHERE Height_Status LIKE '%".$stunted."%'");
	...
	//NORMAL
	$normal_h = "Normal";
    $show_normal_h = $conn->query("SELECT *FROM child_information WHERE Height_Status LIKE '%".$normal_h."%'");
	...
	//TALL 
	$tall = "Tall";
    $show_tall= $conn->query("SELECT *FROM child_information WHERE Height_Status LIKE '%".$tall."%'");
...
//GET STATUS WEIGHT
    ...
    $show_severely_underweight = $conn->query("SELECT *FROM child_information WHERE Weight_Status LIKE '%".$severely_underweight."%'");
    ...
    $show_underweight = $conn->query("SELECT *FROM child_information WHERE Weight_Status LIKE '%".$underweight."%'");
	...
	//NORMAL
	$normal_w = "Normal";
    $show_normal_w = $conn->query("SELECT *FROM child_information WHERE Weight_Status LIKE '%".$normal_w."%'");
    ...
    $show_overweight= $conn->query("SELECT *FROM child_information WHERE Weight_Status LIKE '%".$overweight."%'");
