...
<span>Child Information Table (Male)</span>
...
// Else if current_page is 
	...
	$current_page--;
	  ...
	  echo '<a href="male_table.php?page='.($current_page).'">'.'Previous'.'</a>';
 ...
 for($i = max(1, $page - 3); $i<=min($page + 1, $number_of_pages); $i++) {
  ...
  echo '<li class='.$activeClass.'>'.'<a  href="male_table.php? page='.$i.'">'.$i.'</a>'.'</li>';
...
if($current_page >= $number_of_pages) {
  ...
  echo '<a href="male_table.php? page='.($current_page).'">'.'Next'.'</a>';
